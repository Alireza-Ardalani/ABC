...
public class ContextElementsThread extends ContextElements {
    private int hashCode = 0;


    public ContextElementsThread(ContextElement[] array, int s, String origin, List<String> arrayTop) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        ContextElementsThread other = (ContextElementsThread) obj;
