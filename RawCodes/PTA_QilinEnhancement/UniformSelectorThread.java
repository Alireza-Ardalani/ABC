...
public class UniformSelectorThread extends CtxSelector {
    private final int k;
    private final int hk;

    public UniformSelectorThread(int k, int hk) {
        this.k = k;
        this.hk = hk;
    }
    ...
    public Context select(SootMethod m, Context context) {
        return contextTailor_Thread(context, k);
    }
    ...
    public Context select(AllocNode heap, Context context) {
        return contextTailor_Thread(context, hk);
    }
