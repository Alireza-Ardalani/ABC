...
public class CallsiteCtxComponentConstructor implements CtxConstructor {
    ...
    public Context constructCtx(MethodOrMethodContext caller, ContextAllocNode receiverNode, CallSite callSite, SootMethod target) {
        ...
        return new ContextElementsComponent(array, s + 1, ctxElems.getOffContext(), ctxElems.getTopElements());
    }
}
